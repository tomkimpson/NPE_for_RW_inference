...
\response
We have added Appendix~B, which presents a five-seed reproducibility study. Each model was retrained from scratch with five independent random seeds (42, 123, 456, 789, 1024) while holding the observed data fixed. Table~7 reports the mean and standard deviation of posterior means and 95\% credible interval widths across seeds. Results are highly stable: the maximum standard deviation of any posterior mean across seeds is 0.032 (for $P$ in Model~A), and all seeds achieve 100\% coverage of the true parameter values.
...
\begin{itemize}[nosep]
  ...
  \item \textbf{TARP coverage tests}: Area-under-the-curve (ATC) values quantify calibration quality.
\end{itemize}
