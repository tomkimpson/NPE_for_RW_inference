...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{SBI diagnostics.} A complete diagnostic workflow (simulation-based calibration, TARP coverage tests, classifier two-sample tests) is now reported for all four models (Section~3.5, Table~4, Figure~9).
...
\begin{itemize}[nosep]
  \item \textbf{Simulation-based calibration (SBC)}: 1000 simulations with rank uniformity assessed via Kolmogorov--Smirnov tests. SBC rank ECDF plots are shown in Figure~9.
