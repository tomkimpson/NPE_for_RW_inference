...
The CNN-based approach (Figure~\ref{fig:npe_original_2d}) recovers a posterior with medians $D = 0.156^{+0.026}_{-0.023}$
 and $U = 0.294^{+0.011}_{-0.010}$. As summarised in Table~\ref{tab:data_comparison}, leveraging the full spatial data yields a posterior with a precision comparable to that obtained using curated 1D summary statistics, cf.\ Section~\ref{sec:1d_results}.
