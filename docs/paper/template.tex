...
\begin{table}[htbp]
	...
	\begin{tabular}{@{}lcc@{}}
		...
		\bottomrule
	\end{tabular}
	\caption{Summary of key hyperparameters for the single-round NPE pipeline in the 1D and 2D configurations. All models were trained on an NVIDIA A100-SXM4-80GB GPU using the \texttt{sbi} library \citep{2020JOSS....5.2505T} with a PyTorch backend.}
