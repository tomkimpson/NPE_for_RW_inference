...
\begin{figure}[htbp]
	...
	\caption{SBC rank ECDFs for Model~A (2D): baseline parameterization $(U, P, \rho)$ (left) versus reparameterized $(U, D, v)$ (right). Shaded bands show the 95\% DKW confidence envelope.}
