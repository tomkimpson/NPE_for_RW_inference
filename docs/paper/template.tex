...
NPE with 1D column counts recovers $U = 0.353^{+0.148}_{-0.137}$, $P = 0.764^{+0.085}_{-0.081}$, and $R = 0.052 \pm 0.006$ (Figure~\ref{fig:model_B_1d}). All three true values fall within the 95\% credible intervals. The posterior for $U$ is moderately broad, reflecting a partial degeneracy between initial density and proliferation: higher initial occupancy can mimic the effect of increased growth when only a single time point is observed. Despite this degeneracy, both $P$ and $R$ remain well-constrained. With 2D spatial data, NPE recovers $U = 0.345^{+0.290}_{-0.223}$, $P = 0.777^{+0.158}_{-0.129}$, and $R = 0.053^{+0.013}_{-0.009}$ (Figure~\ref{fig:model_B_2d}). With matched training budgets, the 1D and 2D posteriors are comparable in precision, suggesting that column counts already capture the information relevant to constraining the $U$--$R$ degeneracy in Model~B.
...
NPE with 1D column counts recovers $U = 0.496^{+0.116}_{-0.113}$, $P = 0.671 \pm 0.073$, $\rho = 0.485^{+0.057}_{-0.052}$, and $R = 0.052 \pm 0.003$ (Figure~\ref{fig:model_C_1d}). Despite the four-parameter space, $R$ is recovered with $\sim$6\% relative uncertainty, and the $P$--$\rho$ anti-correlation mirrors the degeneracy observed in Model~A. With 2D spatial data, NPE recovers $U = 0.354^{+0.125}_{-0.119}$, $P = 0.743^{+0.066}_{-0.059}$, $\rho = 0.390^{+0.039}_{-0.037}$, and $R = 0.055^{+0.006}_{-0.004}$ (Figure~\ref{fig:model_C_2d}). The 2D posteriors are tighter for $P$ and $\rho$, suggesting that spatial information provides some additional constraining power for these parameters, while $U$ and $R$ are comparably or better constrained by column counts.
