...
\begin{enumerate}
	...
	\end{equation}
	This learns the transformation $f_\phi(u; x)$ that maps from a simple base distribution to the posterior distribution conditioned on the data.
