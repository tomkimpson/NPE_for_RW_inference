...
\begin{figure}[htbp]
	...
	\end{subfigure}
	\caption{Posterior distributions for Model B (proliferation) with true values $U = 0.5$, $P = 0.7$, $R = 0.05$. Both 1D and 2D representations recover $P$ and $R$ precisely, while $U$ exhibits a partial degeneracy with $R$ reflecting the interchangeability of initial density and proliferation at a single time point.}
